...
namespace reco {
                                                          ...
                                                          larlite::storage_manager& ioll )
  {
    ...
    prongvars.set_verbosity( logger().level() );
    vertexvars.set_verbosity( logger().level() );
    wcoverlapvars.set_verbosity( logger().level() );
    showergapana2d.set_verbosity( logger().level() );
    unrecocharge.setSaveMask(false);
    unrecocharge.set_verbosity( logger().level() );
    cosmictagger.set_verbosity( logger().level() );
    muvsproton.set_verbosity( logger().level() );
