...
io.add_in_filename( "larflow_cluster_eLEE_sample2.root" ) 
io.open()

outio = larlite.storage_manager( larlite.storage_manager.kWRITE )
outio.set_out_filename( "larflow_showerreco_eLEE_sample2.root" )
outio.open()
...
shower_reco = larflow.reco.ShowerReco()
