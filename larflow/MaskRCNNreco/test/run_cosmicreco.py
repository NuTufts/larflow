...
"""
Run LArMatch+MRCNN Cosmic Reco used to get cosmic muon side-band sample
"""

parser = argparse.ArgumentParser("Run LArMatch+MRCNN Cosmic Reco")
# required
...
# ALGORITHMS
recoman = larflow.mrcnnreco.MRCNNCosmicReco( "output_mrcnn_ana.root" )
