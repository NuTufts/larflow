# Visualize Voxels for a batch instead of one cluster
...
parser = argparse.ArgumentParser("Visualize Voxel Data in Batches")
...
# nentries here is how many batches we make
nentries = 5
batchsize = 2
...
#    print("voxel entries: ",data_dict["coord_array"].shape)
    ...
    color = data_dict["coord_t"][:,3] # color is batch index in the array
#    color = data_dict["charge_array"]
    ...
    voxtrace["marker"]["colorscale"]="Jet"
