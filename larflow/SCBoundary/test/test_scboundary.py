...
#z = 500*np.ones( (args.num_samples,) )

dwall = np.zeros( (args.num_samples,) )
for i in range(args.num_samples):
    dwall[i] = scb.dist2boundary( x[i], y[i], z[i] )
dwall[ dwall<0.0 ] = 0.0
dwall[ dwall>0.0 ] = 1.0
...
hits = {
    ...
    "mode":"markers",
    "name":"scb",
    "marker":{"color":dwall,"size":3, "opacity":0.1,"colorscale":"Viridis"}}
