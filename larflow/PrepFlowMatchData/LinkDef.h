...
//#pragma link C++ class std::pair<int,int>+; // already in libCore.so in ROOT
#pragma link C++ class std::map< std::pair<int,int>, int >+;
#pragma link C++ class larflow::prep::WireOverlap+;
#pragma link C++ class larflow::prep::PixData_t+;
...
#pragma link C++ class larflow::prep::MCKeypoint+;
#pragma link C++ class larflow::prep::MCKeypointMaker+;

/* //#pragma link C++ class std::vector< larflow::prep::FlowDir_t >+; */
/* //#pragma link C++ struct larflow::prep::FlowTriples::PixData_t+; */
/* //#pragma link C++ struct larflow::prep::FlowTriples::CropPixData_t+; */
/* //#pragma link C++ class std::vector< std::vector< larflow::prep::FlowTriples::PixData_t > >+; */
/* //#pragma link C++ class std::vector< larflow::prep::FlowTriples::CropPixData_t >+; */
