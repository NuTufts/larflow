...
parser.add_argument("-ct","--input-crttrack", type=str,required=True,help="output of run_crttrack_match.py (larlite)")
...
io.add_in_filename( args.input_crttrack )
io.open()
            ...
            for ev in EVENT_DATA:
                for tr in ev:
                    ...
                    if "opflash" in tr["name"]:
                        ...
                        traces.append( tr )
            if UNMATCHED_CLUSTERS is not None:
