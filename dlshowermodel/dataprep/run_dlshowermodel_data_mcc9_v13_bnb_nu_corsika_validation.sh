...
# TRAINING DATA
OUTPUT_DIR=${DLSHOWERMODEL_DIR}/dataprep/output/outdir_mcc9_v13_bnb_nu_corsika_validation/
INPUTLIST=/cluster/tufts/wongjiradlabnu/twongj01/gen2/photon_analysis/ubdl/larflow/larmatchnet/dataprep/inputlists/mcc9_v13_bnb_nu_corsika_validation.paired.list
...
do
    ...
    output_base=`echo ${larcv_input_base} | sed 's|larcv\_mctruth|dlshowermodel\_trainingdata|' | sed 's|root|h5|'`
