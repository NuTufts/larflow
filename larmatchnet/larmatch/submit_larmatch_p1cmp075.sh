...
#SBATCH --output=gridlog_train_larmatch_wpaf_p1cmp075.log
...
singularity exec --nv --bind /cluster/tufts/:/cluster/tufts/,/tmp:/tmp $container bash -c "source ${WORKDIR}/run_larmatch_training_p100.sh 1"
#echo "TEST"
