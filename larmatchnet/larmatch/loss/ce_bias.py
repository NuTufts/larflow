"""
https://github.com/by-liu/SegLossBias/blob/main/losses_nnunet/ce_bias.py
...
def expand_onehot_labels(labels, target_shape, ignore_index):
    ...
    #print("bin_labels.shape=",bin_labels.shape)
    #print("inds[0].numel()=",inds[0].numel())
...
class CrossEntropyWithL1(CompoundLoss):
    ...
    def forward(self, inputs: torch.Tensor, labels: torch.Tensor):
        ...
        #with torch.no_grad():
        #    print("gt_proportions: ",gt_proportion)
        #    print("pred_proportions: ",pred_proportion)
        #    print("loss_ce=",loss_ce.detach()," loss_reg=",loss_reg.detach()," alpha=",self.alpha)
