...
parser.add_argument("--take-snapshot",action='store_true', default=False, help="If flag given, will save png of event. [default: false]. Need additional arguments")
parser.add_argument("--snapshot-event",default=None,type=int,help="Set snapshot event")
parser.add_argument("--snapshot-filename",default=None,type=str,help="Set name of png file to be made")
