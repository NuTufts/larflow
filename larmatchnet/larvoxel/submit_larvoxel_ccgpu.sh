...
#SBATCH --output=gridlog_train_larvoxel_ccgpu.log
...
#SBATCH --error=gridlog_train_larvoxel.ccgpu.%j.%N.err
...
singularity exec --nv --bind /cluster/tufts/:/cluster/tufts/,/tmp:/tmp $container bash -c "source ${WORKDIR}/run_larvoxel_classifier_training_ccgpu.sh 4"
#echo "TEST"
