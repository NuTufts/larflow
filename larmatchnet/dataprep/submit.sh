...
#SBATCH --output=lmkpsdata_bnb_numu_500.log
#SBATCH --mem-per-cpu=4000
#SBATCH --cpus-per-task=1
#SBATCH --time=4:00:00
#SBATCH --array=400-572
...
DATA_PREP_DIR=/cluster/tufts/wongjiradlabnu/twongj01/gen2/icdl/larflow/larmatchnet/dataprep
